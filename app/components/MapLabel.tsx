...
export default function MapLabel({ location, mapRef, activeLocation }: MapLabelProps) {
  ...
  return (
    <div
      className={`absolute pointer-events-none font-bold text-lg ${activeLocation == location.name ? 'bg-[#47bfbb]/90' : 'bg-[#847cc1]/90'} rounded-xl p-1.5 text-white text-center z-2`}
